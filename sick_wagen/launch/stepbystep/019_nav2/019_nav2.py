...
def generate_launch_description() -> LaunchDescription:
    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            # SLAMとローカリゼーションが有効な場合、SLAM用のlaunchファイルを含む
            ...
            # SLAMが無効でローカリゼーションが有効な場合、ローカリゼーション用のlaunchファイルを含む
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
            ...
            # Keepoutゾーンが有効な場合、Keepoutゾーン用のlaunchファイルを含む
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
            ...
            # Speedゾーンが有効な場合、Speedゾーン用のlaunchファイルを含む
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
    ...
    return ld
# This launch file is used to bring up the navigation stack with various configurations.